...
-- Inserts para tabla `Event`
INSERT INTO `Event` (`EventId`, `Name`, `Description`, `EventDate`, `Price`) VALUES
(1, 'Evento 1', 'Soy un evento 1 del parque', '2024-10-15', 6.0),
(2, 'Evento 2', 'Soy un evento 2 del parque', '2024-10-30', 12.0),
(3, 'Evento 3', 'Soy un evento 3 del parque', '2024-10-31', 7.0),
(4, 'Evento 4', 'Soy un evento 4 del parque', '2024-11-10', 8.0),
(5, 'Evento 5', 'Soy un evento 5 del parque', '2024-12-05', 6.5);

-- inserts para tabla `EmployeeEvent`
...
-- inserts para tabla `VisitorEvent`
...
-- Inserts para tabla `Visit`
INSERT INTO `Visit` (`VisitId`, `VisitorId`, `AttractionId`, `VisitDate`, `Rating`, `Comment`) VALUES
(1, 1, 1,'2024-10-11', 3, 'Esta bueno'),
(2, 2, 2, '2024-10-01', 5, 'Esta excelente'),
(3, 3, 3, '2024-10-11', 3, 'Esta bueno'),
(4, 5, 4, '2024-10-11', 1, 'Esta malo'),
(5, 10, 5, '2024-10-10', 4, 'Esta pasable');

-- Inserts para tabla `Maintenance`
INSERT INTO `Maintenance` (`MaintenanceId`, `AttractionId`, `EmployeeId`, `MaintenanceDate`, `Details`) VALUES
(1, 2, 1, '2024-09-12', 'A,E,I,O,U'),
(2, 1, 3, '2024-09-11', 'A,E,I,O,U'),
(3, 4, 2, '2024-09-10', 'A,E,I,O,U'),
(4, 6, 4, '2024-09-09', 'A,E,I,O,U'),
(5, 8, 5, '2024-09-08', 'A,E,I,O,U');